...
sap.ui.define([
	...
	"sap/m/Text",
	"sap/base/Log"
], function (library, sapMLibrary, Control, Core, AnimationPropertiesResolver, ThemingUtil, Text, Log) {
	"use strict";
	 ...
	 */
	var StatusIndicator = Control.extend("sap.suite.statusindicator.StatusIndicator",
		/** @lends sap.suite.statusindicator.StatusIndicator.prototype */
		{
			metadata: {
				...
				aggregations: {
					 ...
					 */
					groups: {type: "sap.suite.statusindicator.ShapeGroup", multiple: true},

					/**
					 * Defines how shapes are filled based on the status indicator's percentage value.
					 */
					propertyThresholds: {
						type: "sap.suite.statusindicator.PropertyThreshold",
						multiple: true
					},
					 ...
					 */
					discreteThresholds: {
						type: "sap.suite.statusindicator.DiscreteThreshold",
						multiple: true
					},
