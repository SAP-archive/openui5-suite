...
sap.ui.define([
	 ...
	 *
	 * @constructor
	 * @alias sap.suite.controls.util.HtmlElement
	 * @protected
	 */
	var HtmlElement = BaseObject.extend("sap.suite.controls.util.HtmlElement", {
	 ...
	 * @returns {sap.suite.controls.util.HtmlElementRenderer} The newly created renderer instance
	 * @protected
	 */
	 ...
	 * @param {string|sap.suite.controls.util.HtmlElement|sap.ui.core.Control} oChild Child to add.
	 * @protected
	 */
